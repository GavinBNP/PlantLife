...
const Frame3 = () => {
  return (
    <View style={styles.view}>
      ...
      <Text style={[styles.lightIntensity, styles.cdClr]}>Light Intensity</Text>
      <View style={[styles.graph, styles.graphPosition]}>
        <View style={styles.frameGroup}>
          <View style={styles.cdParent}>
            <Text style={[styles.cd, styles.cdClr]}>
              <Text style={styles.text}>{`132 `}</Text>
              <Text style={styles.cd1}>cd</Text>
            </Text>
            <Text
              style={styles.reportOnYour}
            >{`Report on your light intensity `}</Text>
          </View>
      ...
      <Text style={[styles.otherReport, styles.cdClr]}>Other Report</Text>
