...
const Frame4 = () => {
  return (
    <View style={styles.view}>
      ...
      <Text style={[styles.waterPpm, styles.ppmClr]}>Water Ppm</Text>
      <View style={[styles.graph, styles.graphPosition]}>
        <View style={styles.frameGroup}>
          <View style={styles.ppmParent}>
            <Text style={[styles.ppm, styles.ppmClr]}>
              <Text style={styles.text}>{`155 `}</Text>
              <Text style={styles.ppm1}>PPM</Text>
            </Text>
            <Text
              style={styles.reportOnYour}
            >{`Report on your water Ppm `}</Text>
          </View>
      ...
      <Text style={[styles.otherReport, styles.ppmClr]}>Other Report</Text>
