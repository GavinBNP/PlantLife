...
const Frame1 = () => {
  return (
    <View style={styles.view}>
      ...
      <Text style={[styles.waterPh, styles.textFlexBox]}>Water pH</Text>
      ...
      <Text style={[styles.otherReport, styles.textFlexBox]}>Other Report</Text>
