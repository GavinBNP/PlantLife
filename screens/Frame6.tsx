...
const Frame6 = () => {
  return (
    <View style={styles.view}>
      ...
      <Text style={[styles.waterLevel, styles.mmClr]}>Water Level</Text>
      <View style={[styles.graph, styles.graphPosition]}>
        <View style={styles.frameGroup}>
          <View style={styles.mmParent}>
            <Text style={[styles.mm, styles.mmClr]}>
              <Text style={styles.text}>{`155 `}</Text>
              <Text style={styles.mm1}>mm</Text>
            </Text>
            <Text
              style={styles.reportOnYour}
            >{`Report on your water level `}</Text>
          </View>
      ...
      <Text style={[styles.otherReport, styles.mmClr]}>Other Report</Text>
